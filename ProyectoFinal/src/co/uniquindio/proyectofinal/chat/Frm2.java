...
public class Frm2 extends javax.swing.JFrame implements Observer {
    ...
    private void initComponents(String nombre2) {
        ...
        btnEnviar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEnviarActionPerformed(evt, nombre2);
            }
        });
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt, String nombre2) {                                          
 
        String mensaje = nombre2 + ": " + this.txtTextoEnviar.getText() + "\n";
