...
public class CreditoCulturalView extends Composite {

	private Table tableCreditoCultural;
	 ...
	 * @param style
	 */
	public CreditoCulturalView(Composite parent, int style) {
		super(parent, style);
		setLayout(null);

		Group grpListaCreditosCulturales = new Group(this, SWT.NONE);
		grpListaCreditosCulturales.setText("Lista Creditos Culturales");
		grpListaCreditosCulturales.setBounds(10, 10, 576, 233);

	    tableViewer = new TableViewer(grpListaCreditosCulturales, SWT.BORDER | SWT.FULL_SELECTION);
		tableCreditoCultural = tableViewer.getTable();
		tableCreditoCultural.setLinesVisible(true);
		tableCreditoCultural.setHeaderVisible(true);
		tableCreditoCultural.setBounds(10, 20, 556, 203);
		...
		TableColumn tblclmnCosto = tableViewerColumn_7.getColumn();
		tblclmnCosto.setWidth(74);
		...
		Label lblCosto = new Label(grpDetalleCreditoDeportivo, SWT.NONE);
		lblCosto.setBounds(321, 121, 55, 15);
		lblCosto.setText("Costo:");

		txtCosto = new Text(grpDetalleCreditoDeportivo, SWT.BORDER);
		txtCosto.setBounds(392, 118, 164, 21);
